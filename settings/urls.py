...
schema_v1_view = get_schema_view(
    ...
    ),  # Check if all users should be allowed to see the Swagger
)
...
if settings.ENVIRONMENT != "production":
    urlpatterns += [
        ...
        re_path(
            ...
            schema_v1_view.without_ui(cache_timeout=0),
            name="schema-json",
        ),
        re_path(
            r"^swagger/$",
            schema_v1_view.with_ui("swagger", cache_timeout=0),
            name="schema-swagger-ui",
        ),
        re_path(
            r"^redoc/$",
            schema_v1_view.with_ui("redoc", cache_timeout=0),
            name="schema-redoc",
        ),
    ]
